...
jobs:
  ...
  eipw-validator:
    ...
    steps:
      ...
      - uses: ethereum/eipw-action@b858a0f2687c12af12280aa934c3b842747414fd
        id: eipw
        with:
      ...
      - name: Lint
        ...
        with:
          ...
          globs: |
            ...
            ${{ env.CHANGED_FILES }}# Rule details can be found at https://github.com/DavidAnson/markdownlint/blob/main/doc/Rules.md
...
MD010: false[![Auto Review Bot Trigger](https://github.com/ethereum/ERCs/actions/workflows/auto-review-trigger.yml/badge.svg)](https://github.com/ethereum/ERCs/actions/workflows/auto-review-trigger.yml)# Basic writing and formatting syntax
